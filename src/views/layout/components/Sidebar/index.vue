<template>
  <div>
    ...
    <el-menu v-if="menuShow" ref="menu" width="initial" class="sidebar-container">
      <div
        ...
        <el-popover
          ...
          <div
            ...
            <div
              ...
              class="button-name">{{ createButtonTitle }}
            </div>
            <div
              v-show="!buttonCollapse"
              class="button-line"/>
...
export default {
  ...
  methods: {
    ...
    handleDocumentClick(e) {
      if (!this.$refs.menu ||
        this.$refs.menu.$el.contains(e.target)) return

      this.menuShow = false
    },
    toggleMenu() {
      this.$store.commit('SET_COLLAPSE', this.menuShow)
      this.buttonCollapse = this.menuShow
