<template>
  <div class="container">
    <div class="t-section__bd col-12">
    ...
    <flexbox
      ...
      <div class="t-section__ft">
        ...
        <el-button
          ...
          type="primary"
          @click.native="handleTypeClick('edit')">编辑
        </el-button>
        ...
        <el-button
          ...
          icon="wk wk-receive"
          type="primary"
          @click.native="handleTypeClick('get')">领取
        </el-button>
        ...
        <el-button
          ...
          type="primary"
          icon="wk wk-alloc"
          @click.native="handleTypeClick('alloc')">分配
        </el-button>
        ...
        <el-button
          ...
          type="primary"
          icon="wk wk-success"
          @click.native="handleTypeClick('deal_status')">更改成交状态
        </el-button>
    ...
    <flexbox
      ...
      <div
        ...
        v-show="item.title"
        :key="index"
        class="h-item col-sm-6 col-md-4 col-lg-2 col-6"
        span="200">
        <div class="h-title">{{ item.title }}</div>
        <div class="h-value text-one-line"><i
          v-if="item.showIcon"
          :style="item.style"
          :class="item.icon"/>{{ item.value }}
        </div>
      </div>
    </flexbox>
    <slot/>
