      ...
      <div
        ...
        <log-cell
          ...
          <div
            ...
            <span
              class="relate-cell-type">{{ item.activity_type | crmName }}-</span>
            <span
              class="relate-cell-name">{{ item.activity_type_name }}</span>
          </div>
        </log-cell>
      </div>
      <p
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      this.request({ page: this.page, limit: 15, ...this.params, label: 1, activity_type: {
        crm_leads: 1,
        crm_customer: 2,
        crm_contacts: 3,
        crm_business: 5,
