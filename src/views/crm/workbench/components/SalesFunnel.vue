  ...
  methods: {
    ...
    getData() {
      ...
      crmIndexFunnelAPI({
        ...
        this.funnelData = {
          winSingle: resData.sum_ying,
          loseSingle: resData.sum_shu
        }
      }).catch(() => {
        this.loading = false
      })
     ...
     */
    handleCommand(index) {
      if (this.businessId === this.businessOptions[index].type_id) return
      this.businessId = this.businessOptions[index].type_id || null
