  ...
  methods: {
    ...
    getBusinessGroupList() {
      ...
      businessGroupListAPI({
        ...
        .then(res => {
          this.loading = false
          this.businessData = res.data.list.map(item => {
            if (item.create_user_id_info) {
              item.createName = item.create_user_id_info.realname
            }
            return item
          })
    ...
    businessEdit(data) {
      businessGroupReadAPI({
        ...
        .then(res => {
          var settingList = res.data.status || []
          this.businessObj = {
            type_id: res.data.type_id,
            name: res.data.name,
            businessDep: res.data.structure_id || [],
